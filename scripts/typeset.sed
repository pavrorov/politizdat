...
s/\(^\|[[:space:]]\+\|{\)\(\([Сс]м\|[Пп]л\|[Уу]л\|Тов\|[Тт]т\|[Тт]\.т\|Гос\|[Гг]г\|[Гг]\.г\|[Мм]м\|[Мм]\.м\|[Оо]бв\|[Сс]р\)\.}\?\)[[:space:]]\+/\1\2~/g;
...
s/\(^\|[[:space:](]\+\)\(\(\\[[:upper:][:lower:]]\+{\)\?\([[:upper:]][[:lower:]]*\.\\,\)*[[:upper:]]\.}*\)[[:space:]]*\(\(\\[[:upper:][:lower:]]\+{\)\?[[:upper:]][[:lower:]]\{2,\}\)/\1\2\\,\5/g;
s/\(^\|[[:space:](]\+\)\(\(\\[[:upper:][:lower:]]\+{\)\?\(Вл\|Мих\|Дж\)\.}*\)[[:space:]]*\(\(\\[[:upper:][:lower:]]\+{\)\?[[:upper:]][[:lower:]]\{2,\}\)/\1\2\\,\5/g;
